...
export class ContractsService {
  ...
  _tokenContractAddress = '0x2CFc0152EBD4AE03F1A5B59d2581e094255a5355';
 ...
 async signUp(name:any, username:any, password:any){
  ...
  const tx = this._tokenContract.methods.addIndividual(name, username, password);
